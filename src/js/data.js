...
const rows = [
    ["Pasta", 1, "pack", "pantry", "ready"], ["Rice", 1, "pack", "pantry", "ready"], ["Bolognese sauce", 1, "jar", "sauces", "ready"], ["Peppers", 3, "", "produce", "ready"], ["Tomatoes", 3, "", "produce", "ready"], ["Beer", 1.5, "L", "drinks", "open"], ["Pesto sauce", 1, "jar", "sauces", "ready"], ["Carrots", 4, "", "produce", "ready"], ["Parmigiano", 1, "block", "dairy", "open"], ["Mozzarella", 2, "", "dairy", "ready"], ["Bacon", 1, "pack", "protein", "open"], ["Pork shoulder steaks", 12, "", "protein", "frozen"], ["Olive oil", 1, "bottle", "pantry", "ready"], ["White wine vinegar", 1, "bottle", "pantry", "ready"], ["Black pepper", 1, "jar", "spices", "ready"], ["Salt", 1, "jar", "spices", "ready"], ["Rosemary", 1, "jar", "spices", "ready"], ["Parsley", 1, "jar", "spices", "ready"], ["All-purpose seasoning", 1, "jar", "spices", "ready"], ["Paprika", 1, "jar", "spices", "ready"], ["Basil", 1, "jar", "spices", "ready"], ["Bay leaves", 1, "jar", "spices", "ready"], ["Eggs", 10, "", "protein", "ready"], ["Tuna", 1, "can", "protein", "low"], ["Instant noodles", 3, "packs", "pantry", "ready"], ["Milk", 2, "L", "dairy", "open"], ["Cream", 0.5, "L", "dairy", "open"], ["Lemon juice", 1, "bottle", "sauces", "open"], ["Butter", 1, "block", "dairy", "open"], ["Soy sauce", 1, "bottle", "sauces", "open"], ["Bread", 1, "loaf", "pantry", "open"], ["Spicy chorizo", 1, "", "protein", "open"], ["Lettuce", 1, "", "produce", "ready"], ["Closed cup mushrooms", 1, "pack", "produce", "ready"]
];
const seedStock = rows.map(([name, quantity, unit, categoryId, status], index) => ({ id: `seed-${index}`, name, quantity, unit, categoryId, status, createdAt: now - index, updatedAt: now - index }));
